    ...
    <div className="flex flex-col h-screen overflow-hidden bg-gray-50">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
          <div className="bg-white border-b border-gray-200 px-4 lg:px-6 h-12 flex items-center gap-3 flex-shrink-0 lg:hidden">
            <button
            ...
            <span className="text-sm font-semibold text-gray-700">Buyer Portal</span>
          </div>
