...
export default function BuyerComplaintsPage() {
  ...
  useEffect(() => {
    ...
    if (!token) { router.push('/auth/signin?returnUrl=/buyer/complaints'); return; }
    axios
    ...
    <div className="p-4 lg:p-6 max-w-4xl mx-auto">
      ...
      <div className="mt-8 text-center">
        <p className="text-xs text-gray-400">
          ...
          <Link href="/buyer/complaints/grievance" className="text-blue-600 hover:underline">
            Grievance Officer
          </Link>.
        </p>
      </div>
