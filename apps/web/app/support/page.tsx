...
export default function SupportPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!token) {
      setError('Please sign in to file a complaint.');
      return;
    }
          ...
          <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 text-center border border-green-100">
            ...
            <div className="mt-6 flex flex-col gap-3">
              <Link
                ...
                className="block px-5 py-2.5 bg-blue-600 text-white rounded-lg font-semibold hover:bg-blue-700 text-sm"
              >
                View My Complaints
              </Link>
        ...
        <div className="max-w-2xl mx-auto">
          <div className="mb-6">
            ...
            <p className="text-gray-600 mt-1">
              Report an issue with a seller, buyer, or order. We respond within 48 hours.
            </p>
          </div>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-xl px-5 py-4 mb-6 text-sm text-blue-800">
            ...
            <Link href="/contact/grievance-officer" className="underline">
